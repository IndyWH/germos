...
| **7 — Bare metal** | The same binary on a real machine: an HP Compaq Elite 8300 from 2012, booted from a stick the owner flashed by hand. An AHCI driver and a GPT the machine writes itself; an e1000e driver on the 82579LM with a relay answering on the home switch, and a serial monitor that found the one bit that kept it from sending; the EDID guard; the i8042 initialised cold; serial first, so every device reports before the next is touched. The binary that passed the owner's test on it is 40,960 bytes. The Ubuntu 26.04.1 image that boots the same machine from the same drive is 6,482,409,472 bytes, 158,262 times larger. From the firmware's handover to a prompt you can type at: 0.63 seconds, timestamped on the serial chart. Shutdown is the power button. | closed 18 Sep 2026 | [the HP and its screen](history/2026-09-17-ring7c-first-glass-on-metal-1600.jpg) · [hello metal](history/2026-09-17-ring7c-hello-metal-1600.jpg) · [pong](history/2026-09-18-ring7c-pong-on-metal-1600.jpg) · [the calculator from the disk](history/2026-09-18-ring7c-calculator-from-disk-4096-1600.jpg) |
...
![GermOS on the metal — the HP Compaq Elite 8300 booted from the stick on 17 September 2026, its boot log on the monitor at 1920x1080 through Intel's GOP](history/2026-09-17-ring7c-first-glass-on-metal-1600.jpg)
...
![The calculator launched from the HP's own disk with the broker off, 18 September 2026: 4096, `w 000`, `io 000000/000000`, the pointer's field on the strip](history/2026-09-18-ring7c-calculator-from-disk-4096-1600.jpg)
