...
| | |
|---|---|
| Stage | **7 — Metal — ring 7d, the trials, CLOSED 25 September 2026 (opened 22 September), and with it every ring of Stage 7's order** (Stage 7's last ring by the owner's order of 22 September: the trials first, the molt after); `stage7/spec-7d.md` approved by the owner with all seven decisions; `stage7/plan-7d.md` approved at the plan gate with Cowork's four amendments (A1 the reserved prefix `trial `, A2 every block median recomputed exactly, A3 the ±30 ms window never widened by CC, A4 the three Stage 7 gates once per commit) and all fourteen deviations accepted. Rings 7a, 7b, 7c closed (9, 15, 18 September); Stages 0–6 closed. **Next: Stage 8, the molt** |
...
seventh freeze opening. All four automated tests green at item 14 (21
...
**Ring 7d is CLOSED (25 September 2026), and with it every ring of Stage
